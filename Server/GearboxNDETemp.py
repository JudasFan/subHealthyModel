                        ...
                        for abwtgs in temp_value_group.index:
                            if temp_value_group.ix[abwtgs] >= max_value and max_value != 0:
                                AbnormalRecord.append(
                                    [self.wtgs_path['FARM_CODE'].iloc[0], self.wtgs_path['FARM_NAME'].iloc[0],abwtgs, MODEL_NAME, time, temp_value_group.ix[abwtgs], avg_temp,avg_power])
                            else:
                                continue
...
def main():
    ...
    # from_time = "2017-12-20 00:00:00"
    # currentTime = "2017-12-20 00:01:00"
    try:
